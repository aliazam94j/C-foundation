# C Foundation Training

## Who I am

I am a first-year IoT student currently strengthening my C programming foundation
...
I have done embedded systems work in school — GPIO, UART, sensors, microcontrollers.
That work is in my other repositories.

But I noticed a gap: I could write code that worked, but I could not always explain
WHY it worked. I could not explain a pointer to someone without a programming background.
I could not start a new problem without freezing.

So I went back to the basics on purpose.

This repository is that work — C written from scratch, rewritten multiple times,
and explained to myself until I could describe it two ways:
once to a programmer, and once to someone with no technical background at all.
